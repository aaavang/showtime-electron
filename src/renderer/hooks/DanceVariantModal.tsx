...
export const useDanceVariantModal = (): [
  ReturnType<typeof useDisclosure>,
  (props: DanceVariantModalHookProps) => React.ReactNode,
] => {
  const newVariantModal = useDisclosure();
  return [
    newVariantModal,
    ({ onSubmit, initialValue }: DanceVariantModalHookProps) => (
      <DanceVariantModal
        initialValue={initialValue}
        onSubmit={onSubmit}
        disclosure={newVariantModal}
      />
    ),
  ];
};
          ...
          <VStack gap="5px">
            ...
            <>
              ...
              <>
                ...
                <Checkbox
                  isChecked={newVariant.defaultVariant}
                  onChange={(e) => {
                    setNewVariant({
                      ...newVariant,
